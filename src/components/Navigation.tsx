...
export default function Navigation() {
    ...
    // Hide navigation on landing, login, signup, download, and public vibe detail pages
    if (pathname === "/" || pathname === "/login" || pathname === "/signup" || pathname === "/download" || pathname.startsWith("/vibes/")) return null;
